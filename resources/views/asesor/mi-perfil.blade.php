...
<div class="p-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <button onclick="mostrarModalEditarPerfil()" class="flex items-center gap-2 px-6 py-3 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition-colors font-medium">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 mb-6">
                <div class="text-center mb-6">
                    <div class="w-32 h-32 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-4xl font-bold">
                ...
                <div class="space-y-4 border-t pt-4">
                    ...
                    <div class="flex items-center gap-3 text-gray-600">
                        ...
                        <span class="text-sm">Miembro desde: Enero 2024</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Logros</h3>
                <div class="space-y-3">
                    <div class="flex items-center gap-3 p-3 bg-yellow-50 rounded-xl">
                        ...
                        <div class="flex-1">
                            <p class="font-semibold text-gray-800 text-sm">Primer Lugar</p>
                    ...
                    <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-xl">
                        ...
                        <div class="flex-1">
                            <p class="font-semibold text-gray-800 text-sm">Mentor Activo</p>
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-2xl shadow-sm">
                ...
                <div class="p-6">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Historial de Participación</h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-4 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-1">
                                    <h4 class="font-semibold text-gray-800">Hackathon de Innovación 2024</h4>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-sm font-semibold text-gray-800">92.5 pts</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-1">
                                    <h4 class="font-semibold text-gray-800">Feria de Ciencias 2023</h4>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-sm font-semibold text-gray-800">85 pts</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-1">
                                    <h4 class="font-semibold text-gray-800">Concurso de Robótica 2023</h4>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-sm font-semibold text-gray-800">88 pts</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <form>
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" value="{{ Auth::user()->name }}" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Correo electrónico</label>
                    <input type="email" value="{{ Auth::user()->email }}" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Número de control</label>
                    <input type="text" value="{{ Auth::user()->numero_control }}" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
            
            <div class="flex gap-3 mt-6">
                <button type="button" onclick="cerrarModalEditarPerfil()" class="flex-1 px-6 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors font-medium">
                    Cancelar
                </button>
