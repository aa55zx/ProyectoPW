...
<div class="p-8">
    ...
    <nav class="flex mb-4" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1">
            <li>
                <a href="{{ route('asesor.dashboard') }}" class="flex items-center text-gray-500 hover:text-gray-700">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('asesor.proyectos') }}" class="text-sm text-gray-500 hover:text-gray-700">Proyectos</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-sm font-medium text-gray-800">{{ $proyecto->title }}</span>
                </div>
            </li>
        </ol>
    </nav>
