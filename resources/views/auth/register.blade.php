...
@section('title', 'Registrarse - EventTecNM')
...
<div class="flex flex-col items-center justify-center min-h-screen px-4 py-8">
    ...
    <div class="bg-white rounded-3xl shadow-lg p-8 w-full max-w-xl">
        ...
        <div class="flex mb-8 bg-gray-100 rounded-full p-1">
            <a href="{{ route('login') }}" class="flex-1 py-3 px-6 rounded-full text-gray-600 font-medium text-center hover:bg-gray-50 transition-all">
                Iniciar sesión
            </a>
