            ...
            <header class="bg-white border-b border-gray-200 px-8 py-4 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <span class="font-medium text-gray-900">@yield('breadcrumb', 'Dashboard')</span>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative">
                            <input type="text" 
                                   ...
                                   class="w-80 pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-sm">
                        ...
                        <div class="flex items-center gap-3 pl-3 border-l border-gray-200">
                            <div class="relative cursor-pointer">
                                <div class="w-10 h-10 rounded-full overflow-hidden bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-md hover:shadow-lg transition-all">
