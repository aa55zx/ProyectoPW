                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-3 py-1 
                                        <?php if($usuario->role == 'admin'): ?> bg-red-100 text-red-700
                                        <?php elseif($usuario->role == 'juez'): ?> bg-purple-100 text-purple-700
                                        <?php elseif($usuario->role == 'asesor'): ?> bg-orange-100 text-orange-700
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Cheluis\Documentos\7Semestre\Programacion web\ProyectoPW\resources\views/admin/administracion.blade.php ENDPATH**/ ?>