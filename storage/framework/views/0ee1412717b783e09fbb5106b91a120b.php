<?php $__env->startSection('title', 'Rankings - EventTec'); ?>
    ...
    <div class="mb-6">
        <select id="event-selector" class="px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 font-medium bg-white">
            <?php $__currentLoopData = $eventos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($evento->id); ?>" <?php echo e($eventoSeleccionado && $eventoSeleccionado->id === $evento->id ? 'selected' : ''); ?>>
                    <?php echo e($evento->title); ?> (<?php echo e($evento->projects_count); ?> proyectos)
                </option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>

    <?php if($eventoSeleccionado && $proyectosRanking->count() > 0): ?>
        <!-- Podio Top 3 -->
        <?php if($top3->count() >= 3): ?>
            <div class="mb-8">
                    ...
                    <div class="order-1 flex flex-col items-center">
                        <div class="relative mb-4">
                            <div class="w-24 h-24 rounded-full bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center text-white text-3xl font-bold shadow-lg">
                                <?php echo e(strtoupper(substr($top3[1]->team->name, 0, 2))); ?>
                        ...
                        <div class="bg-white rounded-xl p-6 text-center shadow-sm border-2 border-gray-300 w-full">
                            ...
                            <h3 class="font-bold text-gray-900 mb-1"><?php echo e($top3[1]->team->name); ?></h3>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($top3[1]->title, 30)); ?></p>
                            <div class="text-3xl font-bold text-gray-900 mb-1"><?php echo e($top3[1]->final_score); ?></div>
                            <div class="text-xs text-gray-500">puntos</div>
                            <?php if($top3[1]->team->leader): ?>
                                <div class="mt-3 pt-3 border-t border-gray-200">
                                    <p class="text-xs text-gray-600">Líder: <?php echo e($top3[1]->team->leader->name); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="order-2 flex flex-col items-center -mt-8">
                        <div class="relative mb-4">
                            <div class="w-32 h-32 rounded-full bg-gradient-to-br from-yellow-300 to-yellow-500 flex items-center justify-center text-white text-4xl font-bold shadow-xl">
                                <?php echo e(strtoupper(substr($top3[0]->team->name, 0, 2))); ?>
                        ...
                        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 text-center shadow-md border-2 border-yellow-400 w-full">
                            ...
                            <h3 class="font-bold text-gray-900 mb-1 text-lg"><?php echo e($top3[0]->team->name); ?></h3>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($top3[0]->title, 30)); ?></p>
                            <div class="text-4xl font-bold text-yellow-600 mb-1"><?php echo e($top3[0]->final_score); ?></div>
                            <div class="text-xs text-gray-600">puntos</div>
                            <?php if($top3[0]->team->leader): ?>
                                <div class="mt-3 pt-3 border-t border-yellow-300">
                                    <p class="text-xs text-gray-700 font-medium">Líder: <?php echo e($top3[0]->team->leader->name); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="order-3 flex flex-col items-center">
                        <div class="relative mb-4">
                            <div class="w-24 h-24 rounded-full bg-gradient-to-br from-orange-300 to-orange-500 flex items-center justify-center text-white text-3xl font-bold shadow-lg">
                                <?php echo e(strtoupper(substr($top3[2]->team->name, 0, 2))); ?>
                        ...
                        <div class="bg-white rounded-xl p-6 text-center shadow-sm border-2 border-orange-300 w-full">
                            ...
                            <h3 class="font-bold text-gray-900 mb-1"><?php echo e($top3[2]->team->name); ?></h3>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($top3[2]->title, 30)); ?></p>
                            <div class="text-3xl font-bold text-gray-900 mb-1"><?php echo e($top3[2]->final_score); ?></div>
                            <div class="text-xs text-gray-500">puntos</div>
                            <?php if($top3[2]->team->leader): ?>
                                <div class="mt-3 pt-3 border-t border-gray-200">
                                    <p class="text-xs text-gray-600">Líder: <?php echo e($top3[2]->team->leader->name); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
            <div class="p-6 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-600"><?php echo e($proyectosRanking->count()); ?> equipos participaron en <?php echo e($eventoSeleccionado->title); ?></p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="ranking-tbody">
                        <?php $__currentLoopData = $proyectosRanking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proyecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $esMiProyecto = false;
                            ...
                            ?>
                            <tr class="ranking-row hover:bg-gray-50 transition-colors <?php echo e($esMiProyecto ? 'bg-blue-50' : ''); ?>" 
                                data-search="<?php echo e(strtolower($proyecto->team->name . ' ' . $proyecto->title)); ?>">
                                <!-- Posición -->
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        <?php if($proyecto->rank === 1): ?>
                                            <svg class="w-6 h-6 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                            </svg>
                                        <?php elseif($proyecto->rank === 2): ?>
                                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                            </svg>
                                        <?php elseif($proyecto->rank === 3): ?>
                                            <svg class="w-6 h-6 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                            </svg>
                                        <?php endif; ?>
                                        <span class="text-lg font-bold text-gray-900">#<?php echo e($proyecto->rank); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-sm">
                                            <?php echo e(strtoupper(substr($proyecto->team->name, 0, 2))); ?>

                                        </div>
                                        <div>
                                            <div class="font-semibold text-gray-900"><?php echo e($proyecto->team->name); ?></div>
                                            <?php if($proyecto->team->leader): ?>
                                                <div class="text-xs text-gray-500"><?php echo e($proyecto->team->leader->name); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!-- Proyecto -->
                                <td class="px-6 py-4">
                                    <div class="font-medium text-gray-900"><?php echo e($proyecto->title); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e(Str::limit($proyecto->description, 50)); ?></div>
                                </td>

                                <!-- Puntuación -->
                                <td class="px-6 py-4 text-center">
                                    <span class="text-2xl font-bold text-gray-900"><?php echo e($proyecto->final_score); ?></span>
                                    <div class="text-xs text-gray-500">puntos</div>
                                </td>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-900"><?php echo e($stats['proyectos_participados']); ?></div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-900"><?php echo e($stats['puntuacion_maxima']); ?></div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-900"><?php echo e($stats['criterios_evaluados']); ?></div>
...
<?php echo $__env->make('layouts.estudiante', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Cheluis\Documentos\7Semestre\Programacion web\ProyectoPW\resources\views/estudiante/rankings.blade.php ENDPATH**/ ?>