    ...
    <form method="GET" action="<?php echo e(route('admin.rankings')); ?>" class="bg-white rounded-2xl shadow-sm p-6 mb-8 border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex items-end">
                ...
                <a href="<?php echo e(route('admin.rankings')); ?>" class="w-full px-4 py-2.5 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition-colors text-sm font-medium text-center">
                    Limpiar Filtro
                </a>
                <?php else: ?>
                <button type="button" disabled class="w-full px-4 py-2.5 bg-gray-100 text-gray-400 rounded-xl cursor-not-allowed text-sm font-medium">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Cheluis\Documentos\7Semestre\Programacion web\ProyectoPW\resources\views/admin/rankings.blade.php ENDPATH**/ ?>