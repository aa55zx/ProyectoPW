<?php $__env->startSection('title', 'Evaluar Proyecto - EvenTec'); ?>
<?php $__env->startSection('breadcrumb', 'Evaluaciones > Evaluar Proyecto'); ?>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
        <div class="flex items-start justify-between mb-6">
            <div class="flex-1">
                <h1 class="text-3xl font-bold text-gray-900 mb-3"><?php echo e($project->title); ?></h1>
                <div class="flex flex-wrap items-center gap-6 text-sm text-gray-600">
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        <span class="font-medium">Equipo: <?php echo e($project->team->name); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                        </svg>
                        <span class="font-medium">Líder: <?php echo e($project->team->leader->name); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <span class="font-medium">Evento: <?php echo e($project->event->title); ?></span>
                    </div>
                </div>
            </div>
        ...
        <?php if($project->team->members->isNotEmpty()): ?>
            <div class="mb-6">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">Miembros del Equipo</h3>
                <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = $project->team->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="bg-gray-50 rounded-xl p-6">
            ...
            <?php if($project->description): ?>
                <p class="text-gray-700 leading-relaxed mb-4"><?php echo e($project->description); ?></p>
            <?php else: ?>
                <p class="text-gray-500 italic">No hay descripción disponible</p>
            <?php endif; ?>
            
            <?php if($project->demo_url || $project->repository_url || $project->presentation_url): ?>
                <div class="flex flex-wrap items-center gap-4 mt-4">
                    <?php if($project->presentation_url): ?>
                        <a href="<?php echo e($project->presentation_url); ?>" 
                           target="_blank"
                    ...
                    <?php if($project->repository_url): ?>
                        <a href="<?php echo e($project->repository_url); ?>" 
                           target="_blank"
                           class="text-indigo-600 hover:text-indigo-700 font-medium flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <form method="POST" action="<?php echo e(route('juez.guardar-evaluacion', $project->id)); ?>" id="evaluationForm" class="space-y-8">
        <?php echo csrf_field(); ?>
        
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Criterios de Evaluación</h2>
            
            <?php if($rubric && $rubric->criteria->isNotEmpty()): ?>
                <div class="space-y-6">
                    <?php $__currentLoopData = $rubric->criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    ...
                                    <?php if($criterion->description): ?>
                                        <p class="text-sm text-gray-600 ml-11"><?php echo e($criterion->description); ?></p>
                                    <?php endif; ?>
                                </div>
                                <div class="text-right ml-4">
                                    <p class="text-xs text-gray-500 mb-1">Puntos máximos</p>
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($criterion->max_points); ?></p>
                                </div>
                            </div>
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-3">
                                        <input type="number" 
                                               ...
                                               id="score_<?php echo e($criterion->id); ?>"
                                               min="0" 
                                               max="<?php echo e($criterion->max_points); ?>" 
                                               step="0.5"
                                               value="<?php echo e($criterion->max_points / 2); ?>"
                                               onchange="updateScores()"
                                               oninput="updateScores()"
                                               class="w-32 px-4 py-3 text-2xl font-bold text-center border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['scores.'.$criterion->id];
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <button type="button" 
                                                    onclick="incrementScore('<?php echo e($criterion->id); ?>', <?php echo e($criterion->max_points); ?>)"
                                            ...
                                            <button type="button" 
                                                    onclick="decrementScore('<?php echo e($criterion->id); ?>')"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="ml-11 mt-4">
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div id="progress_<?php echo e($criterion->id); ?>" 
                    ...
                    <div class="pt-6 border-t-2 border-gray-200">
                        ...
                        <textarea name="comments" 
                                  rows="6" 
                                  class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none <?php $__errorArgs = ['comments'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Proporciona retroalimentación constructiva y detallada para el equipo..."><?php echo e(old('comments')); ?></textarea>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 border-2 border-indigo-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-white rounded-xl p-4 shadow-sm">
                                ...
                                <p id="totalRawScore" class="text-3xl font-bold text-gray-900"><?php echo e(number_format($rubric->criteria->sum('max_points') / 2, 1)); ?></p>
                                <p class="text-xs text-gray-500 mt-1">de <?php echo e($rubric->criteria->sum('max_points')); ?> puntos</p>
                            </div>
...
const criteriaConfig = {
    <?php $__currentLoopData = $rubric->criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        '<?php echo e($criterion->id); ?>': {
            maxPoints: <?php echo e($criterion->max_points); ?>,
            weight: <?php echo e($criterion->max_points); ?>

        },
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
};

const maxTotalPoints = <?php echo e($rubric->criteria->sum('max_points')); ?>;
...
<?php echo $__env->make('layouts.juez', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Cheluis\Documentos\7Semestre\Programacion web\ProyectoPW\resources\views/juez/evaluar-proyecto.blade.php ENDPATH**/ ?>