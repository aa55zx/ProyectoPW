                    ...
                    <div class="flex items-center gap-4 ml-6">
                        ...
                        <div class="flex items-center gap-3 pl-4 border-l border-gray-200">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center">
                                <span class="text-white font-semibold text-xs"><?php echo e(substr(Auth::user()->name, 0, 2)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\em556\Desktop\ProyectoPW\resources\views/layouts/asesor-dashboard.blade.php ENDPATH**/ ?>