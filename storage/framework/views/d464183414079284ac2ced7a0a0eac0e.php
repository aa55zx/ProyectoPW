            ...
            <div class="proyecto-card bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all overflow-hidden" 
                ...
                <div class="p-6 pb-4">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <a href="<?php echo e(route('asesor.proyecto-detalle', $proyecto->id)); ?>" class="w-full px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium text-center">
                            Ver Detalle
                        </a>
...
<?php echo $__env->make('layouts.asesor-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\merin\Downloads\ProyectoPW\resources\views/asesor/proyectos.blade.php ENDPATH**/ ?>